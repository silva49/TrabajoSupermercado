...
INSERT INTO `tblcategorias` VALUES (1,'lacteos'),(2,''),(3,'carnicos');
...
--
insert into tblventas values(null, 1, 2, 1000);

LOCK TABLES `tblproductos` WRITE;
/*!40000 ALTER TABLE `tblproductos` DISABLE KEYS */;
INSERT INTO `tblproductos` VALUES (1,1,'queso',500);
...
-- Dump completed on 2020-02-23 13:28:53
